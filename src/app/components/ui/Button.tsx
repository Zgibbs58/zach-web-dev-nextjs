...
const Button: React.FC<ButtonProps> = ({ children, variant, link }) => {
  ...
  switch (variant) {
    ...
    case "mobileButton":
      className =
        "text-white bg-emerald-500 rounded-lg hover:bg-emerald-700 font-semibold ease-in-out duration-300 flex flex-col content-end justify-center items-center px-4 py-1";
      break;
    case "none":
      className = "hidden";
