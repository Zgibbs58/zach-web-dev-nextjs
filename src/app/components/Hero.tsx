...
export default function Hero() {
  return (
    <section
      className="relative flex items-center justify-start bg-cover bg-center py-40 md:py-36 2xl:py-52 max-h-screen"
    ...
    >
      ...
      <div className="relative text-left px-4 md:px-8 w-full xl:w-1/2 mx-8 lg:mx-32">
        <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: "easeOut", duration: 1, delay: 0 }}>
          <h1 className="text-4xl lg:text-5xl 2xl:text-6xl font-bold text-white leading-9">
            Websites <br className="sm:hidden" /> That Grow
            <br className="sm:hidden" /> Your Business
          </h1>
        </motion.div>
