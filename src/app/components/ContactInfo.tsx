  ...
  return (
    <>
      <div className="flex flex-row items-center gap-2">
        ...
        <p id="contact-email" className="text-md"></p>
      </div>
      <div className="flex flex-row items-center gap-2">
        <svg
          enableBackground="new 0 0 512 512"
        ...
        <a
          href="https://linkedin.com/in/zacharywgibbs"
          target="_blank"
          rel="noreferrer"
          aria-label="LinkedIn"
          className="text-md"
        >
          linkedin.com/in/zacharywgibbs
        </a>
      </div>
      <div className="flex flex-row items-center gap-2">
        <svg
      ...
      <div className="flex flex-row items-center gap-2">
        <svg
          ...
          xmlSpace="preserve"
          xmlns="http://www.w3.org/2000/svg"
          className="svgIcon h-12 w-12 duration-150 ease-in-out hover:scale-90"
        >
          <g>
